...
public class TestMainActivity extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void testShouldShowEnterCityRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bCity);
        openListFragment(R.id.bRank);
    }

    public void testShouldShowEnterHighwayRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bHighway);
        openListFragment(R.id.bRank);
    }

    public void testShouldShowBrandMaxVelocityRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bBrand);
        openListFragment(R.id.bRank);
    ...
    public void testShouldShowModelMaxVelocityRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bModel);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_maximumVelocity);
    ...
    public void testShouldShowModelTotalTicketsRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bModel);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_totalTickets);
    ...
    public void testShouldShowModelAverageExcededRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bModel);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_averageExceded);
    ...
    public void testShouldShowHighwayMaxVelocityRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bHighway);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_maximumVelocity);
    ...
    public void testShouldShowHighwayTotalTicketsRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bHighway);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_totalTickets);
    ...
    public void testShouldShowHighwayAverageExcededRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bHighway);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_averageExceded);
    ...
    public void testShouldShowStateMaxVelocityRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bState);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_maximumVelocity);
    ...
    public void testShouldShowStateTotalTicketsRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bState);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_totalTickets);
    ...
    public void testShouldShowStateAverageExcededRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bState);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_averageExceded);
    ...
    public void testShouldShowTypeMaxVelocityRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bType);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_maximumVelocity);
    ...
    public void testShouldShowTypeTotalTicketsRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bType);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_totalTickets);
    ...
    public void testShouldShowTypeAverageExcededRanking(){
        this.mActivity = getActivity();
        openListFragment(R.id.bType);
        openListFragment(R.id.bRank);
        openListFragment(R.id.button_averageExceded);
